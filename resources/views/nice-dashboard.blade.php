...
<head>
  ...
  <title>Ricm Bank - Portifólio</title>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/remixicon@2.5.0/fonts/remixicon.css" integrity="sha512-CWRnZlthFAu05mm4Pu5R/ikDV/2jPo6cgmkpdtBFWUY9/mqNFuTmgwnpBWqDiIeMdn5wv1NEQFdt82/Ak+uzkg==" crossorigin="anonymous" referrerpolicy="no-referrer">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <span class="d-none d-lg-block">Ricm Bank</span>
      </a>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      Projeto de portifólio por <strong><span>Ricardo Moisés de Lima</span></strong>. Foco no backend
    </div>
    <div class="credits">
      ...
      Designed by <a href="https://bootstrapmade.com/">BootstrapMade</a> and edited by <a href="https://ricm.dev/">Ricardo Moisés de Lima</a>
    </div>
  </footer><!-- End Footer -->
